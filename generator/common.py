...
def create_generator(language):
    ...
    dostepne_jezyki = {'Bulgarian': 'bg_BG', 'Czech': 'cs_CZ', 'German': 'de_DE',
                       'Danish': 'dk_DK', 'Greek': 'el_GR', 'Australia': 'en_AU', 'Canada': 'en_CA',
                       'English': 'en_GB', 'USA': 'en_US', 'Spanish': 'es_ES',
                       'Mexico': 'es_MX', 'Persian': 'fa_IR', 'Finnish': 'fi_FI',
                       'French': 'fr_FR', 'Hindi': 'hi_IN', 'Italian': 'it_IT', 'Japanese': 'ja_JP',
...
def rwnd(nr_of_digits):
    '''Losowy INT o ścisle określonej dlugosci.'''
    from random import randint
    range_start = 10**(nr_of_digits-1)
    range_end = (10**nr_of_digits)-1
