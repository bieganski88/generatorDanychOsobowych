...
"""
# lista kodow
pkd = ["A	01	01.1	01.11	PKD 01.11.Z	Uprawa zbóż, roślin strączkowych i roślin oleistych na nasiona, z wyłączeniem ryżu", 
...
def tworz_pkd():
    ...
    for k in range(len(pkd)):
        tresc.append(pkd[k][28:])
        kody.append(pkd[k][:28])
    
    # rozbijam kody na elementy atomowe
    wartosci, linia = [], []
    for k in range(len(kody)):
